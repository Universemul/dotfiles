...
export PYCHARM_ROOT="$HOME/pycharm"
export PATH="$PYCHARM_ROOT/bin:$PATH"
...
export PS1="\[\033[36m\]\u@\h \[\033[32m\]\w\[\033[33m\]\[\033[00m\]\$(parse_python_env)\[\033[33m\]\$(parse_git_branch)\$\033[0m "
...
alias open='xdg-open .'
alias gos='./manage.py shell_plus --ipython'
